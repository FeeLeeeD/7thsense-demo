...
import { PlaceOfEngagementMap } from "./charts/place-of-engagement-map";
import { TimeOfEngagementChart } from "./charts/time-of-engagement";
  ...
  return (
    <Box as="section">
      ...
      <Flex justify="flex-end">
        <Link
          to={(route) => route.analytics.people.index()}
