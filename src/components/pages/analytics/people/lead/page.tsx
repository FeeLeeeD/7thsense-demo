...
import { OpenRatesHeatMap } from "./charts/open-rates-heatmap";
...
export const AnalyticsLeadPage = () => {
  return (
    <PageLayout
...
const SentEmailsList = (props: BoxProps) => {
  const openEmailStatistics = () => {
    navigate((route) => route.analytics.emails.email());
  };
  ...
  return (
    <Box as="section" {...props}>
      ...
      <Flex justify="flex-end">
        <Link
          to={(route) => route.analytics.emails.index()}
