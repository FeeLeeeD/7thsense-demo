...
import { data } from "~data/charts/engagement-conversion-click-percentages";
...
const chartId = "engagement-converison-click-percentages";

const emails = Object.keys(data[0]).filter((k) => k !== "date");

export const EngagementConversionClickPercentagesChart = () => {
  useLayoutEffect(() => {
