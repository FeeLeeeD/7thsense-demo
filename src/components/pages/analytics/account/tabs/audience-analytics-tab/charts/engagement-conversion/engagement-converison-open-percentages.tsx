...
import { data } from "~data/charts/engagement-conversion-open-percentages";
...
const chartId = "engagement-conversion-open-percentages";

const emails = Object.keys(data[0]).filter((k) => k !== "date");

export const EngagementConversionOpenPercentagesChart = () => {
  useLayoutEffect(() => {
