...
import { data } from "~data/charts/engagement-conversion-open-numbers";
...
const chartId = "engagement-conversion-open-numbers";

const emails = Object.keys(data[0]).filter((k) => k !== "date");

export const EngagementConversionOpenNumbersChart = () => {
  useLayoutEffect(() => {
